...
def run():
    ...
    io.imsave('./testImages/testedimgcorduroy_pebbles8.png',np.reshape(x_test[0], (128,128)))
    yHey = np.reshape(y_test[0], (128,128))
    yHey *= 255
    io.imsave('./testImages/testedimgcorduroy_True_pebbles8.png', yHey)
    io.imsave('./testImages/testedimg_predictioncorduroy_pebbles8.png', predictimage)
